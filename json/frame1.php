...
<div class="container">
  <!-- Texto -->
  <h1 class="mt-3">Bienvenido Al Cine</h1>
  <!-- Imagen -->
  <img src="img/komi-log.png" alt="Maestro" height="350"><br>
  <!-- Botón -->
  <a href="frame.php" type="button" class="btn btn-info">Regresar</a>
  <a href="mostrar.html" type="button" class="btn btn-info">Siguiente</a>
</div>
...
if (usuario=="maestro" && password=="123") { 
